...
<sub>[oddsnends.user.js](https://raw.githubusercontent.com/chrislowles/userscripts/main/oddsnends.user.js): random odds and ends for personal my day to day. Now consolidated with: breezewiki-tweaks, bsky-to-blueviewer, gemini-link-fixer, letterboxd-review-autoexpander, phanpy-auto-local, simpcity-tweaks, yt-autoexpand-comments.</sub>